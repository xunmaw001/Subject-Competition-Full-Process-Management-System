<template>
	<div class="addEdit-block" :style='{"minHeight":"100vh","padding":"30px 40px 30px","backgroundAttachment":"fixed","background":"url(http://codegen.caihongy.cn/20230316/ceb93d14d79c4fe1835e7b1e4ec86ed2.jpg)","backgroundSize":"100% 100%","backgroundPosition":"left top","backgroundRepeat":"no-repeat","height":"auto"}' style="width: 100%;">
		...
		>
			<template >
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="竞赛名称" prop="jingsaimingcheng">
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="select" v-if="type!='info'"  label="竞赛类型" prop="jingsaileixing">
					<el-select :disabled="ro.jingsaileixing" v-model="ruleForm.jingsaileixing" placeholder="请选择竞赛类型" >
						<el-option
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="upload" v-if="type!='info' && !ro.jingsaitupian" label="竞赛图片" prop="jingsaitupian">
					<file-upload
						tip="点击上传竞赛图片"
						action="file/upload"
						:limit="3"
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="upload" v-else-if="ruleForm.jingsaitupian" label="竞赛图片" prop="jingsaitupian">
					...
					<img v-else class="upload-img" style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.jingsaitupian.split(',')" :src="$base.url+item" width="100" height="100">
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="竞赛人数" prop="jingsairenshu">
					<el-input v-model="ruleForm.jingsairenshu" placeholder="竞赛人数" clearable  :readonly="ro.jingsairenshu"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else class="input" label="竞赛人数" prop="jingsairenshu">
					<el-input v-model="ruleForm.jingsairenshu" placeholder="竞赛人数" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="date" v-if="type!='info'" label="竞赛时间" prop="jingsaishijian">
					<el-date-picker
						value-format="yyyy-MM-dd HH:mm:ss"
						v-model="ruleForm.jingsaishijian" 
						type="datetime"
						:readonly="ro.jingsaishijian"
						placeholder="竞赛时间"
					></el-date-picker>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-else-if="ruleForm.jingsaishijian" label="竞赛时间" prop="jingsaishijian">
					<el-input v-model="ruleForm.jingsaishijian" placeholder="竞赛时间" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="竞赛地点" prop="jingsaididian">
					<el-input v-model="ruleForm.jingsaididian" placeholder="竞赛地点" clearable  :readonly="ro.jingsaididian"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else class="input" label="竞赛地点" prop="jingsaididian">
					<el-input v-model="ruleForm.jingsaididian" placeholder="竞赛地点" readonly></el-input>
				</el-form-item>
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="textarea" v-if="type!='info'" label="竞赛规则" prop="jingsaiguize">
					<el-input
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else-if="ruleForm.jingsaiguize" label="竞赛规则" prop="jingsaiguize">
					<span :style='{"fontSize":"14px","lineHeight":"40px","color":"#000","fontWeight":"500","display":"inline-block"}'>{{ruleForm.jingsaiguize}}</span>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-if="type!='info'"  label="竞赛介绍" prop="jingsaijieshao">
					<editor 
						style="min-width: 200px; max-width: 600px;"
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else-if="ruleForm.jingsaijieshao" label="竞赛介绍" prop="jingsaijieshao">
                    <span :style='{"fontSize":"14px","lineHeight":"40px","color":"#000","fontWeight":"500","display":"inline-block"}' v-html="ruleForm.jingsaijieshao"></span>
                </el-form-item>
...
export default {
		...
		init(id,type) {
			...
			if(this.type=='info'||this.type=='else'){
				...
				for (var o in obj){
						...
						if(o=='jingsaitupian'){
							this.ruleForm.jingsaitupian = obj[o];
    ...
    info(id) {
      this.$http({
        ...
        this.ruleForm.jingsaijieshao = this.ruleForm.jingsaijieshao.replace(reg,'../../../ssme41wj/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
	...
	if(this.ruleForm.jingsaitupian!=null) {
		this.ruleForm.jingsaitupian = this.ruleForm.jingsaitupian.replace(new RegExp(this.$base.url,"g"),"");
	}
...
var objcross = this.$storage.getObj('crossObj');
    ...
    jingsaitupianUploadChange(fileUrls) {
	    this.ruleForm.jingsaitupian = fileUrls;
    },
  }
};
</script>
