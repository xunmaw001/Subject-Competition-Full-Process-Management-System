<template>
	<div class="addEdit-block" :style='{"minHeight":"100vh","padding":"30px 40px 30px","backgroundAttachment":"fixed","background":"url(http://codegen.caihongy.cn/20230316/ceb93d14d79c4fe1835e7b1e4ec86ed2.jpg)","backgroundSize":"100% 100%","backgroundPosition":"left top","backgroundRepeat":"no-repeat","height":"auto"}' style="width: 100%;">
		...
		>
			<template >
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="模拟训练名称" prop="name">
					<el-input v-model="ruleForm.name" placeholder="模拟训练名称" clearable  :readonly="ro.name"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else class="input" label="模拟训练名称" prop="name">
					<el-input v-model="ruleForm.name" placeholder="模拟训练名称" readonly></el-input>
				</el-form-item>
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="select" v-if="type!='info'"  label="模拟训练状态" prop="status">
					<el-select :disabled="ro.status" v-model="ruleForm.status" placeholder="请选择模拟训练状态" >
						<el-option
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else class="input" label="模拟训练状态" prop="status">
					<el-input v-model="ruleForm.status?'启用':'禁用'" 
						placeholder="模拟训练状态" readonly></el-input>
				</el-form-item>
			</template>
...
export default {
	data() {
		...
		return {
			...
			rules: {
				name: [
					{ required: true, message: '模拟训练名称不能为空', trigger: 'blur' },
				],
				time: [
				...
				status: [
					{ required: true, message: '模拟训练状态不能为空', trigger: 'blur' },
					{ validator: validateIntNumber, trigger: 'blur' },
				],
			}
		};
