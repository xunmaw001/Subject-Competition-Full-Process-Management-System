      ...
      <el-form :style='{"margin":"0 0 20px"}' :inline="true" :model="searchForm" class="center-form-pv">
		<el-row :style='{"display":"block"}'>
			<div :style='{"margin":"0 10px 0 0","display":"inline-block"}'>
			  ...
			  <el-input v-model="searchForm.name" placeholder="模拟训练名称" clearable></el-input>
			</div>
        ...
        >
          ...
          <el-table-column :resizable='true' :sortable='true' prop="name" header-align="center" align="center" sortable label="模拟训练">
