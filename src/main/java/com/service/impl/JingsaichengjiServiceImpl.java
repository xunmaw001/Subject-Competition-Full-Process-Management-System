...
public class JingsaichengjiServiceImpl extends ServiceImpl<JingsaichengjiDao, JingsaichengjiEntity> implements JingsaichengjiService {
    ...
    @Override
    public List<Map<String, Object>> selectValue(Map<String, Object> params, Wrapper<JingsaichengjiEntity> wrapper) {
        return baseMapper.selectValue(params, wrapper);
    }

    @Override
    public List<Map<String, Object>> selectTimeStatValue(Map<String, Object> params, Wrapper<JingsaichengjiEntity> wrapper) {
        return baseMapper.selectTimeStatValue(params, wrapper);
    }

    @Override
    public List<Map<String, Object>> selectGroup(Map<String, Object> params, Wrapper<JingsaichengjiEntity> wrapper) {
        return baseMapper.selectGroup(params, wrapper);
    }
    @Override
    public List<Map<String, Object>> jingsaimingchengjingsaichengjiSectionStat(Map<String, Object> params, Wrapper<JingsaichengjiEntity> wrapper) {
        return baseMapper.jingsaimingchengjingsaichengjiSectionStat(params, wrapper);
    }
