...
public class JingsaibaomingServiceImpl extends ServiceImpl<JingsaibaomingDao, JingsaibaomingEntity> implements JingsaibaomingService {
    ...
    @Override
    public List<Map<String, Object>> selectValue(Map<String, Object> params, Wrapper<JingsaibaomingEntity> wrapper) {
        return baseMapper.selectValue(params, wrapper);
    }

    @Override
    public List<Map<String, Object>> selectTimeStatValue(Map<String, Object> params, Wrapper<JingsaibaomingEntity> wrapper) {
        return baseMapper.selectTimeStatValue(params, wrapper);
    }

    @Override
    public List<Map<String, Object>> selectGroup(Map<String, Object> params, Wrapper<JingsaibaomingEntity> wrapper) {
